 ...
 *
 * <p>발행: 플래너 — {@code POST /api/planners/join}({@code PlannerMemberService}) 과
 *    {@code POST /api/planners/invitations/{invitationId}/accept}
 *    ({@code PlannerInvitationService}) 에서 {@code group_member} 저장 직후
